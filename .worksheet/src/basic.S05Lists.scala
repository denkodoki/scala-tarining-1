...
object S05Lists {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(56); 
  ...
  1 :: 2 :: 3 :: Nil;System.out.println("""res3: List[Int] = """ + $show(res$3));$skip(27); 
  
  val List(a, b, c) = l;System.out.println("""a  : Int = """ + $show(a ));System.out.println("""b  : Int = """ + $show(b ));System.out.println("""c  : Int = """ + $show(c ));$skip(28); 
