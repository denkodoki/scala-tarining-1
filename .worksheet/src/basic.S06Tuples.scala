...
object S06Tuples {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(63); 
  ...
  pair._2;System.out.println("""res1: String = """ + $show(res$1));$skip(37); 
