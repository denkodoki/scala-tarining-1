...
object S03Operators {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(62); 

  println("Operators");$skip(25); val res$0 = 
  
  // infix
  
  1 + 2;System.out.println("""res0: Int(3) = """ + $show(res$0));$skip(21); val res$1 = 
  
  1 + 2 == 1.+(2);System.out.println("""res1: Boolean = """ + $show(res$1));$skip(39); 
  
  val s = "Sors bona nilhil aliud!";System.out.println("""s  : String = """ + $show(s ));$skip(45); val res$2 = 
  
  s indexOf ('o', 3) == s.indexOf('o', 3);System.out.println("""res2: Int = """ + $show(res$2));$skip(39); 
  
  // prefix  +-!~
  
  val d = -2.0;System.out.println("""d  : Double = """ + $show(d ));$skip(50); val res$3 = 
  
  (-2.0) == ((2.0).unary_-) == ((2.0) unary_-);System.out.println("""res3: Boolean = """ + $show(res$3));$skip(54); val res$4 = 
  
  // postfix
  
  s.toLowerCase == (s toLowerCase);System.out.println("""res4: Boolean = """ + $show(res$4));$skip(53); val res$5 = 
  
  // equality
  
  List(1, 2, 3) == List(1, 2, 3);System.out.println("""res5: Boolean = """ + $show(res$5));$skip(24); val res$6 = 
  ...
  null == null;System.out.println("""res8: Boolean = """ + $show(res$8));$skip(211); 
  ...
  one +* two *= nine;System.out.println("""res10: classes.Funy = """ + $show(res$10));$skip(31); 
