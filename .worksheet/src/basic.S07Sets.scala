...
object S07Sets {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(77); 
   ...
   fteam += "Bean";System.out.println("""res4: basic.S07Sets.fteam.type = """ + $show(res$4));$skip(19); val res$5 = 
   fteam += "Bean";System.out.println("""res5: basic.S07Sets.fteam.type = """ + $show(res$5))}
}
