...
object S01traits {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(54); 
  println("traits");$skip(27); 
  ...
  q;System.out.println("""res2: traits.FifoQueue = """ + $show(res$2));$skip(160); 
  ...
  q2;System.out.println("""res5: traits.FifoQueue with traits.Filtering with traits.Transforming = """ + $show(res$5));$skip(90); 
  ...
  q3;System.out.println("""res6: traits.IncreasingDoublingQueue = """ + $show(res$6));$skip(42); 
